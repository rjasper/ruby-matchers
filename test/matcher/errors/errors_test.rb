...
module Matcher
  class ErrorsTest < ActiveSupport::TestCase
    ...
    test 'nested(:foo, a) & nested(:foo, b) => nested(:foo, and(a, b))' do
      a, b = %w[a b].map { element(_1) }
    ...
    test 'nested(:foo, a) & nested(:bar, b) => and(nested(:foo, a), nested(:bar, b))' do
      a, b = %w[a b].map { element(_1) }
    ...
    test 'nested(:foo, a) & and(nested(:foo, b), *c) => and(nested(:foo, and(a, b), *c)' do
    ...
    test 'nested(:bar, a) & and(nested(:foo, b), *c) => and(nested(:foo, a), nested(:bar, b), *c)' do
      a, b, c = %w[a b c].map { element(_1) }
    ...
    test 'nested(:foo, a) | nested(:foo, b) => nested(:foo, or(a, b))' do
      a, b = %w[a b].map { element(_1) }
    ...
    test 'nested(:foo, a) | nested(:bar, b) => or(nested(:foo, a), nested(:bar, b))' do
      a, b = %w[a b].map { element(_1) }
    ...
    test 'nested(:foo, a) | or(nested(:foo, b), *c) => or(nested(:foo, or(a, b), *c)' do
      a, b, c = %w[a b c].map { element(_1) }
    ...
    test 'nested(:bar, a) | or(nested(:foo, b), *c) => or(nested(:foo, a), nested(:bar, b), *c)' do
      a, b, c = %w[a b c].map { element(_1) }
    ...
    test 'and(nested(:foo, a), *b) & nested(:foo, c) => and(nested(:foo, and(a, c), *b)' do
      a, b, c = %w[a b c].map { element(_1) }
    ...
    test 'and(nested(:foo, a), *b) & nested(:bar, c) => and(nested(:foo, a), *b, nested(:bar, c))' do
      a, b, c = %w[a b c].map { element(_1) }
    ...
    test 'and(nested(:foo, a), *b) & and(nested(:foo, c), *d) => and(nested(:foo, and(a, c), *b, *d)' do
    ...
    test 'and(nested(:foo, a), *b) & and(nested(:bar, c), *d) => and(nested(:foo, a), *b, nested(:bar, c), *d)' do
      a, b, c, d = %w[a b c d].map { element(_1) }
    ...
    test 'or(nested(:foo, a), *b) | nested(:foo, c) => or(nested(:foo, or(a, c), *b)' do
      a, b, c = %w[a b c].map { element(_1) }
    ...
    test 'or(nested(:foo, a), *b) | nested(:bar, c) => or(nested(:foo, a), *b, nested(:bar, c))' do
      a, b, c = %w[a b c].map { element(_1) }
    ...
    test 'or(nested(:foo, a), *b) | or(nested(:foo, c), *d) => or(nested(:foo, or(a, c), *b, *d)' do
      a, b, c, d = %w[a b c d].map { element(_1) }
    ...
    test 'or(nested(:foo, a), *b) | or(nested(:bar, c), *d) => or(nested(:foo, a), *b, nested(:bar, c), *d)' do
      a, b, c, d = %w[a b c d].map { element(_1) }
