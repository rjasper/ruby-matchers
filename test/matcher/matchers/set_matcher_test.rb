...
describe Matcher::SetMatcher do
  it 'match array' do
    ...
    assert_expected_errors matcher.match([]),
      ...
      'expected 1 to be included in []',
      'expected 2 to be included in []',
      'expected 3 to be included in []'
    assert_expected_errors matcher.match([1, 2, 3, 4]),
      'expected length of 3 but got 4'
    assert_expected_errors matcher.match([1, 2, 4]),
      'expected 3 to be included in [1, 2, 4]',
      2 => 'did not expect 4 to be included in [1, 2, 4]'
  ...
  it 'pass parent' do
    ...
    assert_expected_errors matcher.match([1]),
      ...
      0 => 'did not expect 1 to be included in [1]'
  end
